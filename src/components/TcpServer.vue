  ...
  <div class="h-full flex flex-col">
    ...
    <div v-if="isVercel" class="flex-1 flex items-center justify-center p-8">
      <div class="text-center max-w-md space-y-3">
        ...
        <h3 class="text-lg font-semibold text-surface-700 dark:text-surface-200">TCP Server Unavailable</h3>
        <p class="text-sm text-surface-500 dark:text-surface-400 leading-relaxed">
          TCP Server requires a backend runtime to listen on ports. This feature is only available in local deployment mode.
        </p>
